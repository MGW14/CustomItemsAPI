...
public class CustomRecipe {
	...
	private CustomItemStack result; // You will get this item if the things above are right
	
	// Another Constructor
	public CustomRecipe(CustomItemStack topleft, CustomItemStack topmid, CustomItemStack topright,
			CustomItemStack middleleft, CustomItemStack middlemid, CustomItemStack middleright,
			CustomItemStack downleft, CustomItemStack downmid, CustomItemStack downright, CustomItemStack result) {
		super();
	...
	// Create a Recipe from this. Not used for you!
	public ShapedRecipe getRecipe(String namespaced, JavaPlugin plugin) {
		ShapedRecipe sr = new ShapedRecipe(new NamespacedKey(plugin, namespaced), CustomItemStack.fromCiSforCrafting(result));
		String a = " ";
		String b = " ";
		String c = " ";
		if (topleft != null) {
